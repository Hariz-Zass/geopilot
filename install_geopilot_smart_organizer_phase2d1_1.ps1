...
Write-Host "============================================================"
Write-Host "GeoPilot Smart Organizer Phase 2D.1.1"
...
$backup=Join-Path $root "artifacts\smart_organizer_phase2d1_1_backup_$stamp"
$log=Join-Path $root "artifacts\smart_organizer_phase2d1_1_result.txt"
...
try {
  ...
  if($frontend.Contains("SMART_ORGANIZER_PHASE2D1_FRONTEND")){throw "Previous failed Phase 2D.1 patch appears to remain. STOP for audit."}
...
'@
  ...
  @"
============================================================
SMART ORGANIZER PHASE 2D.1.1 PASS
============================================================
