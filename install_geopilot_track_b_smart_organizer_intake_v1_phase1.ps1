...
Write-Host "============================================================"
Write-Host "GeoPilot Track B Smart Organizer Intake V1 - Phase 1"
Write-Host "Inspect-only / NO DB WRITE / NO MIGRATION"
Write-Host "============================================================"

$root=(Get-Location).Path
$stamp=Get-Date -Format "yyyyMMdd_HHmmss"
$backup=Join-Path $root "artifacts\smart_organizer_intake_v1_phase1_backup_$stamp"
...
'@ | Add-Content $css -Encoding UTF8
 ...
 Write-Host "============================================================"
 Write-Host "TRACK B SMART ORGANIZER INTAKE V1 - PHASE 1 PASS"
 Write-Host "============================================================"
