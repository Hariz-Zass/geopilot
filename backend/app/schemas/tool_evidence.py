...
class EvidenceSourceRef(BaseModel):
    model_config=ConfigDict(extra='forbid'); kind:Literal['document_chunk','policy_reference','compliance_fact','compliance_finding','suitability_result','gis_feature','raster_dataset','temporal_measurement','user_input','external_provider']; id:uuid.UUID|str; hash:str|None=None
