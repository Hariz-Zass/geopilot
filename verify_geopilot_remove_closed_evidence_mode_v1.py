...
files = [
    ...
    Path("/frontend/src/pages/TrackBWorkspacePage.tsx"),
]
...
print("remaining_closed_mode_markers:", len(failed))
for item in failed:
    print("REMAINS:", item)
...
frontend = Path("/frontend/src/pages/TrackBWorkspacePage.tsx").read_text(encoding="utf-8-sig")
...
checks = {
    ...
    "closed_badge_removed": "CLOSED EVIDENCE MODE" not in frontend,
    "external_disabled_copy_removed": "external acquisition disabled" not in frontend,
