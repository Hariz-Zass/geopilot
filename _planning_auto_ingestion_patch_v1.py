...
if "def register_acquired_document" in text and "def ingest_acquired_document" in text:
    print("SKIP: Auto-ingestion pipeline V1 already installed.")
    raise SystemExit(0)
    ...
    *,
    ...
    request = PlanningDocumentCreateRequest(
        ...
        initial_version={
            ...
            "review_state": (
                "requires_review"
                if provenance["document_status"] != "verified_in_force"
                else "unreviewed"
            ),
...
def ingest_acquired_document(
    ...
    *,
    ...
    try:
        ...
        # Existing lower layers own their own rollback/state transitions.
        raise
'''
